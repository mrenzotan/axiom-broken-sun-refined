# DEV-47: Enemy Roster — Axiom of the Broken Sun
...
| 4 | Null-King | Final Boss | None | 300/22/10/9 | 200 | Anti-chemistry |
...
3. Fields to populate per enemy:
...
4. Boss-specific fields (Phase 5):
...
5. Sprite and Animator Controller assignment (Phase 5):

...
3. Keep `docs/GAME_PLAN.md` and `AGENTS.md` in mind when the plan is ambiguous — architecture there overrides improvisation.
...
`AGENTS.md`: there is **no** command-line Unity test/build pipeline here unless the user added one.
